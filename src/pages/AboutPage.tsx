        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            {[
              ...
              "Now, as I complete my Honours Bachelor of Computer Science while maintaining a 3.7 GPA, I'm preparing for the next chapter: a Master's program at the University of Texas at Austin. Every late night study session, every complex algorithm mastered, every project deployed - it's all been leading to this moment.",
